      ...
      <div class="contact-content">
        ...
        <div class="contact-form-container">
          <div class="form-header">
            <h3 class="form-title">Fale Conosco</h3>
          ...
          <form @submit.prevent="submitForm" class="contact-form">
            ...
            <!-- Confirmação de Entrega Protegida -->
            <div class="form-group">
              <div class="protected-delivery">
                ...
                <div class="delivery-content">
                  <span class="delivery-title"
                    >Entrega Protegida pela Caixa</span
                  >
                  <span class="delivery-description"
                    >Seu investimento está garantido pelo maior banco público do
                    país</span
                  >
                </div>
              </div>
              ...
              <label class="checkbox-container">
                ...
                <span class="checkbox-label"
                  >Confirmo que entendi a proteção oferecida pela Caixa
                  Econômica Federal</span
                >
              </label>
            </div>
  ...
  setup() {
    ...
    const submitForm = async () => {
      ...
      try {
        ...
        const formData = {
          Nome_Completo: form.value.name,
          Telefone: form.value.phone,
          "E-mail": form.value.email,
          "Renda familiar": form.value.familyIncome,
          "Valor de parcela que procura": form.value.installmentValue,
        };

        console.log("Enviando dados para Make.com:", formData);

        // Enviar para Make.com
        // @https://hook.eu2.make.com/mjxthixyva104axff8vxw772ravcnqyv
        ...
        if (response.ok) {
          ...
          window.open(
            `https://wa.me/553115746070?text=${encodedMessage}`,
            "_blank",
          );
          ...
          alert(
            "Formulário processado! Você será redirecionado para o WhatsApp.",
          );
        }
      } catch (error) {
    ...
    const openWhatsApp = () => {
      ...
      const message = encodeURIComponent(
        "Olá Miguel! Pode me falar mais sobre o empreendimento:",
      );
    ...
    const openEmail = () => {
      trackContact();
      window.open(
        "mailto:vendas@jardinsresidence.com.br?subject=Interesse no Jardins Residence",
        "_self",
      );
    };
...
/* Responsividade para entrega protegida */
@media (max-width: 768px) {
  .protected-delivery {
    flex-direction: column;
    text-align: center;
